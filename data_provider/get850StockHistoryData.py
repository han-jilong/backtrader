...
def get_stock_history_data(code, start_date, end_date):
    ...
    rs = bs.query_history_k_data_plus(code, columns, start_date=start_date, end_date=end_date, adjustflag="1", frequency="d")
    # 打印结果集
    data_list = []
...
if __name__ == '__main__':
    ...
    dir = os.path.join(modpath, '..\\datas\\850stocks\\')
    ...
    for stock in stockCodes:
        ...
        datapath = os.path.join(modpath, '..\\datas\\850stocks\\' + file_name)
